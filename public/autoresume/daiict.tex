...
\usepackage{hhline}
\usepackage{hyperref}
\hypersetup{pdftex, colorlinks=true, linkcolor=blue, citecolor=blue, filecolor=blue, urlcolor=blue, pdftitle=, pdfauthor=ismail - [2010], pdfsubject=, pdfkeywords=}
...
~
 &
\multicolumn{2}{m{5.13926in}}{{\textless}No more than 2 Line
description{\textgreater}\ \ 
...
\raggedleft\arraybslash Team Size -{\textless}if any{\textgreater}\\
\multicolumn{2}{m{6.5914598in}}{{\textless}one to two line short
\ description{\textgreater}
